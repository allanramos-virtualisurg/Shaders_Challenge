Shader "URP/RaymarchSphere_Specular"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float sdSphere(float3 p)
            {
                ...
                return length(p_shifted) - _SphereRadius;
            }
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                float3 viewDir = normalize(IN.positionWS - rayOrigin);
                ...
                for (int i = 0; i < 64; i++)
                {
                    ...
                    if (d < 0.001) 
                    {
                        ...
                        // --- AMBIENT ---
                        float3 ambient = SampleSH(normal) * 0.1; 
